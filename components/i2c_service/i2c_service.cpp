...
static const char *const TAG = "i2c_service";

void I2CServiceComponent::setup() {
...
void I2CServiceComponent::update() {
  this->get_i2c_slave()->upsert_i2c_registry(this->reg_key_, this->sensor_->state);
}

void I2CServiceComponent::dump_config() {
  ESP_LOGCONFIG(TAG, "I2C Services:");
